export const English = {
  ...
  th: '',
  exportKey: 'Export keystore file',
  passwordToEncrypt: 'Password to encrypt the keystore:',
  keystorePath: 'Path to save the keystore:',
  passwordShort: 'Password needs to be at least 6 characters long',
  storagePermission: 'Unable to get access into storage!',
  keystoreAlreadyExists: 'File at given path already exists!',
  exporting: 'Exporting in progress...',
  exportingDesc: 'Exporting in progress, please wait... This may take few minutes on some devices.',
  keystoreSaved: 'Keystore was successfully exported',
}
